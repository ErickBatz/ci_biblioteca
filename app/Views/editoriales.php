            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?=base_url('buscarEditorial/').$editorial['codigo_editorial'];?>" class="btn btn-primary">Actualizar</a>
                            <!--eliminar tiene la ruta eliminar/codigo-->
                            <a href="<?=base_url('eliminarEditorial/').$editorial['codigo_editorial'];?>" class="btn btn-danger">eliminar</a>
                        </td>
                    </tr>
                    <?php 
                        }
